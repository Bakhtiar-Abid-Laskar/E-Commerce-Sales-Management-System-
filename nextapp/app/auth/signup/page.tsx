...
import { Mail, Eye, EyeOff, AlertCircle, CheckCircle, Loader, ArrowRight, UserPlus } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center p-4 relative overflow-hidden bg-[#0d0f1a]">
      ...
      >
        ...
        <div className="backdrop-blur-xl bg-white/[0.03] border border-white/[0.1] rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="relative px-8 py-10 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-indigo-100/90 font-medium">Join SalesTracker today</p>
            </div>
          </div>
            ...
            {success && (
              <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-4 flex gap-3 items-start">
                ...
                <div className="text-sm text-emerald-300">
                  ...
                  <p>Check your email to confirm. Redirecting...</p>
                </div>
              </div>
            )}
        ...
        {/* Card Glow Effect */}
        <div className="absolute -inset-0.5 bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-pink-500/20 rounded-3xl blur-xl -z-10 opacity-50" />
      </div>
